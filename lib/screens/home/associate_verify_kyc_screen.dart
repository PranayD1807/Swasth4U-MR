...
import 'package:demo/widgets/popup_verify_associate.dart';
import 'package:flutter/material.dart';
import 'package:mask_text_input_formatter/mask_text_input_formatter.dart';

class AssociateVerifyKYCScreen extends StatefulWidget {
  const AssociateVerifyKYCScreen({Key? key}) : super(key: key);

  @override
  State<AssociateVerifyKYCScreen> createState() =>
      _AssociateVerifyKYCScreenState();
}

class _AssociateVerifyKYCScreenState extends State<AssociateVerifyKYCScreen> {
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      const Padding(
                        ...
                        child: Text(
                          "Enter Details to verify Associate KYC",
                          textScaleFactor: 1.3,
                          ...
                          onPressed: () {
                            showGeneralDialog(
                              ...
                              pageBuilder: (_, __, ___) {
                                return const PopUpVerifyAssociate();
                              },
                            );
                          },
                          child: const Text(
