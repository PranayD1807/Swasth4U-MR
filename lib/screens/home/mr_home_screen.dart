...
class MRHomeScreen extends StatelessWidget {
  const MRHomeScreen({Key? key}) : super(key: key);
  @override
  Widget build(BuildContext context) {
    ...
    List<Map> tools = [
      ...
      {
        "path": "assets/work_report_icon.png",
        "text": "Work Report",
        "page": const WorkReportScreen()
      },
      {
      ...
      {
        "path": "assets/associate_onboarding_icon.png",
        "text": "Associate Onboarding",
        "page": const AssociateOnboardingScreen(),
      },
      {
        "path": "assets/ant-design_unordered-list-outlined_icon.png",
        "text": "Associates List",
        "page": const AssociateListScreen()
      },
      {
        "path": "assets/kyc.png",
        "text": "Associate KYC",
        "page": const AssociateKYCScreen(),
      },
      {
