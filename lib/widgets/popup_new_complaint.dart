...
class PopupNewComplaint extends StatefulWidget {
  const PopupNewComplaint({Key? key, this.isEditing = false}) : super(key: key);
  final bool isEditing;
  @override
  State<PopupNewComplaint> createState() => _PopupNewComplaintState();
}

class _PopupNewComplaintState extends State<PopupNewComplaint> {
